...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
&quot;<xsl:value-of select="bncDoc/@xml:id"/>&quot;,&quot;<xsl:value-of select="bncDoc/teiHeader/profileDesc/textClass/classCode"/>&quot;,&quot;<xsl:value-of select="bncDoc/teiHeader/fileDesc/sourceDesc/bibl/title"/>&quot;,&quot;<xsl:value-of select="bncDoc/teiHeader/fileDesc/sourceDesc/bibl/imprint/date"/>&quot;
  </xsl:template>
